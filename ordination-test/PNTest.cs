...
public class PNTest
{
    ...
    public void GivDosisTest()
    {
        ...
        bool givDosis_tc2 = tc2.givDosis(new Dato { dato = new DateTime(2023, 01, 04).Date });
        ...
        bool givDosis_tc3 = tc3.givDosis(new Dato { dato = new DateTime(2023, 1, 12).Date });
        ...
        bool givDosis_tc4 = tc3.givDosis(new Dato { dato = new DateTime(2024, 12, 31).Date });
